...
const GAME_INDEX_CACHE_SCHEMA: u32 = 5;
...
pub(crate) fn collect_cached_game_index_root(
    ...
    if matches!(
        ...
        return collect_game_index_root_with_profile(target, root, profile);
    }
    let files = collect_game_index_files(root, profile)?;
